# Generated by Django 3.2.6 on 2021-09-23 23:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_user', to=settings.AUTH_USER_MODEL, verbose_name='ユーザー')),
            ],
            options={
                'verbose_name': '勤務時間',
